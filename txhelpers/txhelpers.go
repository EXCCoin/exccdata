...
func OutPointAddresses(outPoint *wire.OutPoint, c RawTransactionGetter,
	params *chaincfg.Params) ([]string, exccutil.Amount, error) {
	...
	value := exccutil.Amount(txOut.Value)
...
func VoteBitsInBlock(block *exccutil.Block) []stake.VoteVersionTuple {
...
func TotalOutFromMsgTx(msgTx *wire.MsgTx) exccutil.Amount {
	var amtOut int64
