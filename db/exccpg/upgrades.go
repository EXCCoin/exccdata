...
// style is run after updating exccdata past version 3.0.0.
...
// lnfeatures agenda ids exist since appropriate voting mechanisms on the exccd
...
func (pgb *ChainDB) CheckForAuxDBUpgrade(exccdClient *rpcclient.Client) (bool, error) {
